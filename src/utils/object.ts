...
export const convertKeyToSnakeCase = (data: any) =>
  mapKeys(data, (__, key) => snakeCase(key))

export const convertKeyToCamelCase = (data: any) =>
  mapKeys(data, (__, key) => camelCase(key))
...
export const isEmpty = (source: KeyValueObj): boolean =>
